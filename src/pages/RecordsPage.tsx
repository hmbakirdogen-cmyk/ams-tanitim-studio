  ...
  return (
    <div className="flex h-full flex-col gap-4 overflow-y-auto pr-1">
      ...
      <Tilt3D className="glass flex items-center gap-3 rounded-2xl p-4" max={4}>
        ...
        />
        <button onClick={saveNow} disabled={data.log.length === 0} className="shrink-0 rounded-lg px-4 py-2 text-sm font-semibold text-white transition disabled:opacity-40" style={{ background: 'linear-gradient(135deg,#0072CE,#2E9BFF)' }}>
          Kaydet
        </button>
      </Tilt3D>

...
**⭐ SIRADAKİ (yeni oturum #1 — GÖRME tazelenince):** TÜM görselleri Mehmet'in zevkine göre KUSURSUZ yap — [[kullanici-mehmet-profili]] "Görsel zevki": (a) görselde **boş/beyaz alan YOK**, (b) ürün **KOMPLE + pencereye göre MAX ebatta** (büyük, çerçeveyi doldursun), (c) lüzumsuz kısımlar (uzun kablo vb.) **kırpılır**, (d) **güçlü/okunur tipografi**. ÖNCE giriş hero'su (`ams-scene-hero.jpg` — beyaz alan/çerçeve sorunu vardı; slogan zaten kaldırıldı), SONRA ürün hero + tüm görseller bu gözle denetlenir. Bu oturumda görsel-limiti yüzünden gözle doğrulanamadı; yeni oturumda Read ile gör + headless screenshot ile iterasyon. Görsel havuzu kaynakları [[smc-gorsel-kaynaklari]]'nda (gerekirse #3 dikey poster/#5 izometrik fabrika yeniden indirilebilir).
